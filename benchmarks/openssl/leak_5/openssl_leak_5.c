 ...
 */
static int verify(X509 *leaf, X509 *root, void *crls,
                  unsigned long flags)
{
    X509_STORE_CTX *ctx = malloc(10);
    X509_STORE *store = malloc(10);
    X509_VERIFY_PARAM *param = malloc(10);		/* allocation site */
    void *roots = malloc(10);
...
{
    return verify(test_leaf, test_root, NULL,
